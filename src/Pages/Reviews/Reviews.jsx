...
const Reviews = () => {
    ...
    return (
        <div className="body brightness-100 min-h-screen flex items-top justify-center bg-gradient-to-r from-purple-800 to-purple-400">
            <div className="bg-origin-border p-10 border-20 border-dashed bg-purple-100">

                <h2 className="text-4xl font-extrabold pt-20 ">
